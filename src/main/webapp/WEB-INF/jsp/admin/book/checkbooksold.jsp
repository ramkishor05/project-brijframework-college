...
<script>
					...
					success : function(data, status) {
						...
						if (length == 0) {
							...
							st = st
									...
									+ '</div><div class="block"  style="width: 626px; height: 208px; top: 53px;">'
									+ '<table class="table table-bordered table-primary" style="margin-top: 20px;"><thead><tr><th>S.no</th><th>Date</th><th>Amount</th><th>Action</th></tr></thead><tbody>';
							for (var i = 0; i < length; i++) {
								st += '<tr><td>'
										...
										+ '</td><td>'
										+ j[i].totalAmount
										+ '</td><td><a href="javascript:showdetails('
										+ j[i].studentwiseFeeId
										+ ')">'
	...
	function getstudentdetailsofbook() {
				...
				.ajax({
					...
					success : function(data, status) {
						...
						if (length == 0) {
							...
							st = st
									+ '<div><div class="widget-body"  style="padding: 10px 0px 0px; margin-top: -50px;"><div class="separator"></div><div class="btn-group" style="width: 400px;">'
									+ '</div><div class="block"  style="width: 626px; height: 208px; top: 53px;"><div class="head blue"><h4 style="text-align:center"> Sold Book details</h4></div>'
...
<div class="detailbox">
	<div class="detailbox-header">
		...
		<center>
			<h5 id="myModalLabel">Sold Book Detais</h5>
		</center>
	</div>
...
<div class="content">
	<div id="content-header" style="height: 150px;">
		...
		<h1>View details of books sold</h1>
		<h3>ClassWise Sold Book Details</h3>
	...
	<table
		...
		<tr style="height: 0px;">
			...
			<td><select id="classId" onchange="getstudentdetailsofbook();"
