...
<script>
	function getCollectionDetails(month) {
		$
				.ajax({
					type : "post",
					url : 'show-available-collection-details',
					data : {
						'month' : month,
					},
...
<div class="content">
	<div id="content-header" style="height: 150px;">
		...
		<h1>Collections</h1>
		<h3>Show Monthly Collections & Expenses Details & Available
			Details</h3>
	...
	<div class="row-form">
		...
		<div class="span4">
			<select onchange="getCollectionDetails(this.value)">
				<option value="">Select Month</option>
				<c:forEach var="month" items="${monthList}" begin="0"
					end="${fn:length(monthList)-2}">
