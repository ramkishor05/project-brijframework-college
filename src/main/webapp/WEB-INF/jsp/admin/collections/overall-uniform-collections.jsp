	...
	<div style="padding: 10px 0 0;" class="widget-body">
		<div class="block">
			<div class="head blue">
				...
				<h2>Overall Collections from Uniform</h2>
				<ul class="buttons">
					<li><a return false; title="Overall Uniform Collections"
						href="overall-uniform-collections.xls?pageno=1"><div class="icon">
				...
				<tr style="width: 10px;">
					<c:if test="${pageno > 1}">
						<td style="text-align: left;"><a
							href="show-overall-uniform?pageno=${pageno - 1}">Previous</a></td>
					</c:if>
					...
					<c:forEach begin="1" end="${totalNoOfPages}" var="i">
						<c:choose>
							...
							<c:otherwise>
								<td style="text-align: left;"><a
									href="show-overall-uniform?pageno=${i}"><c:out value="${i}"></c:out></a></td>
							</c:otherwise>
						</c:choose>
					</c:forEach>
					<td style="text-align: center;">&nbsp;&nbsp;</td>
					<c:if test="${pageno < totalNoOfPages}">
						<td style="text-align: left;"><a
							href="show-overall-uniform?pageno=${pageno + 1}">Next</a></td>
					</c:if>
				</tr>
			</table>
		</div>
