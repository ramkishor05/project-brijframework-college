	...
	<div style="padding: 10px 0 0;" class="widget-body">
		<div class="block">
			<div class="head blue">
				...
				<h2>Overall Collections from Books</h2>
				<ul class="buttons">
					<li><a return false; title="Overall Books Collections" href="overall-book-collections.xls?pageno=1"><div class="icon">
				...
				<tr style="width: 10px;">
					<c:if test="${pageno > 1}">
						<td style="text-align: left;"><a
							href="show-overall-book?pageno=${pageno - 1}">Previous</a></td>
					</c:if>
					...
					<c:forEach begin="1" end="${totalNoOfPages}" var="i">
						<c:choose>
							...
							<c:otherwise>
								<td style="text-align: left;"><a
									href="show-overall-book?pageno=${i}"><c:out
											value="${i}"></c:out></a></td>
							</c:otherwise>
						</c:choose>
					</c:forEach>
					...
					<c:if test="${pageno < totalNoOfPages}">
						<td style="text-align: left;"><a
							href="show-overall-book?pageno=${pageno + 1}">Next</a></td>
					</c:if>
				</tr>
			</table>
		</div>
