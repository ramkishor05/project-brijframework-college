				...
				.ajax({
					...
					success : function(data, status) {
						...
						$("#monthwithfeedetail").empty();
                          ...
                          $("#myModalLabel").text(obj.employeeDTO.firstName
								+ obj.employeeDTO.lastName);
						var monthwithfeedetail = '<div class="head green"style="width: 1049px;"><div class="icon"><span class="ico-brush"></span></div>';
						...
						monthwithfeedetail += '<div class="data-fluid"><div class="classshowheader"style="width: 1061px;"><table width="100%" cellspacing="0" cellpadding="0" class="table table-hover" >';
						...
						$
								.each(
										...
										function(key, value) {
											...
											-parseInt(fineAmount)-parseInt(value.advanceAmount);
											...
											monthwithfeedetail += '<td  width="6%" style="background-color: #FFFFCC;">'
													...
													+ '/'
													+ value.totalDays
													+ '</td><td width="7%" style="background-color: #FFFFCC"><a href="javascript:viewadvances('+value.monthId+','+id+','+sessionId+');">'+value.advanceAmount+'</td><td  width="6%" style="background-color: #FFFFCC">'
													+ value.fineAmount
											...
											if (value.recieptNo == 0) {
												monthwithfeedetail += '<td  width="6%" style="background-color: #FFFFCC">-</td>';
											} else {
												monthwithfeedetail += '<td  width="6%" style="background-color: #FFFFCC"><a href="generatePDFslip.html?slipNo='
														+ value.slipNo
...
<div class="content">
	<div id="content-header" style="height: 150px;">
		<img alt="Show_settings"
			src="${img_url}/employeeImages/salary.jpg"
			...
			<table class="table table-bordered table-primary">
				...
				<c:forEach var="list" items="${allemployees}" varStatus="loop"
					...
					<tr>
						...
						<td><a href="javascript:getEmployeeSalaryDetails(
														'${list.id} ');"><span
	...
	<div class="feecategorycreateedit-header">
		<a href="javascript:hidefeecategorycreateedit();" class="close"
			...
			aria-hidden="true">×</a>
		<center><h4 id="myModalLabel"  style="padding-top: 5px;">Salary Payment Details</h4></center>
	</div>
		...
		<div class="row-fluid" style="margin-top: 20px;">
			<div class="block-fluid">
				...
				<div class="row-form">
					<div class="span8">
				<div class="block"
					style="float: right; width: 1052px; left: 359px; margin-bottom: -7px; top: -35px;"
		...
		<div class="feecategorycreateedit-footer" style="float: right; margin-top: -37px;">
...
<input type="hidden" value="${current.sessionId}" id="sessionId">
	...
	<div id="ShowDetails"
			style="float: right; z-index: 1; height: 220px; position: fixed; top: 225px; right: 296px; width: 309px;">
