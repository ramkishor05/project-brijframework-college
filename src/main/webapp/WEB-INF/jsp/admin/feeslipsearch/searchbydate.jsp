					...
					<div class="row-form">
						...
						<div class="span9">
							<input type="text" class="datepicker validate[required]"
								placeholder="Select From Date" id="fromDate" onchange="getClear();">
						</div>
					</div>
					<div class="row-form">
						...
						<div class="span9">
							<input type="text" class="datepicker validate[required]"
								placeholder="Select To Date" id="toDate" onchange="javascript:searchbyslipno();">
						</div>
					</div>
					<div class="row-form">
						<div class="span3"></div>
