...
<div class="content">
	<div class="page-header">
		...
		<h2>Search by Slip No.</h2>
		<h3>Search by slip No.</h3>
		...
		<!-- <div style="float: right; margin-top: 11px; margin-right: 30px;">
			<a href="search-by-student-name.html" class="btn btn-success"
				...
				style="margin-right: 5px;">Search By Date</a> <a
				href="search-by-admission.html" class="btn btn-success"
				style="margin-right: 5px;">Search By Admission No</a>
		</div> -->
	</div>
	<div class="row-fluid">
		<div class="span6">
			<div class="block">
				<div class="data-fluid">
					<div class="row-form">
						<div class="span3">Enter Slip No:</div>
						<div class="span9">
							<input type="text" id="slipno" onkeyup="javascript:searchbyslipno();" >
						</div>
					</div>
					<!-- <div class="row-form">
						<div class="span3"></div>
