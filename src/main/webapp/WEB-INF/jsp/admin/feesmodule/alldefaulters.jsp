...
<c:choose>
<c:when test="${list.categoryName=='Nothing'}">
<div class="failedmsg" style="margin-top: 42px;">Due Date is not assigned for all months.Go to Settings-> Manage Due Date->and Create Due Date.</div>
