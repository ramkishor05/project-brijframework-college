...
function deletestudentwisefee(classId, sectionId, studentWiseFeeId, monthId,studentAdmissionNo) {
	$(".successmsg").remove();
		$("#msg").empty();
		$
				.ajax({
						...
						success : function(data) {
							...
							if (obj != '') {
								...
								$.each(obj, function(key, value) {
									...
									+ ','
									+ value.monthId
									+ ','+$('#studentAdmissionNo').val()+');"><span class="label label-important">Delete</span></a></td></tr>';
								});
