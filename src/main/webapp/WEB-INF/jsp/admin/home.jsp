...
<div class="content">
	...
	<marquee>
		<font color="green"><b>Current Session is
				${current.sessionDuration}</b></font>
	</marquee>
	<div id="user_options">
		...
		<div class="button-box">
			<a href="uniform-menu" class="option_buttons"
		...
		<div class="button-box">
			<a href="create-holidays.html" class="option_buttons"
				id="examinations_button" nicetitle="Manage Examinations"><div
					...
					<p style="border-top-width: 0px; margin-top: 10px;">Create
						Holidays</p>
				</div></a>
		</div>
		<div class="button-box">
		...
		<div class="button-box">
			<a href="backup.html" class="option_buttons" id="examinations_button"
				nicetitle="Manage Examinations"><div class="button-label">
					<img alt="" src="${img_url}/backups.jpg"
						style="margin-left: -20px; margin-top: -100px; height: 100px;">
					<p style="border-top-width: 0px; margin-top: 10px;">DataBase
						BackUp</p>
				</div></a>
		</div>
		<div class="button-box">
			<a href="all-fee-submission-report" class="option_buttons"
				id="examinations_button" nicetitle="Manage Examinations"><div
					class="button-label">
					<img alt="" src="${img_url}/excel_icon.jpg"
						style="margin-left: -20px; margin-top: -100px; height: 100px;">
					<p style="border-top-width: 0px; margin-top: 10px;">All Fee Submission</p>
				</div></a>
		</div>
	</div>