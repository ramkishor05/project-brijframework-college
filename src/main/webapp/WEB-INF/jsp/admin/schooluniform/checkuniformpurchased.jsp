					...
					success : function(data, status) {
						...
						if (length == 0) {
							...
							st = st
									...
									+ '</div><div class="block"  style="width: 626px; height: 208px; top: 53px;"><div class="head blue"><h4 style="text-align:center">'+name+'&nbsp;'+category+'&nbsp;'+size+'</h4></div>'
...
<div class="content">
	<div id="content-header" style="height: 140px;">
		<img alt="Show_settings" src="${img_url}/uniform.jpg"
			style="width: 50px;">
		<h1>View Purchased Uniform Details</h1>
		<h3>View details of uniforms purchased</h3>
	...
	<div class="widget-body"
		...
		<div class="block" style="width: 352px;">
			<div class="head blue" class="head blue"
				...
				<h2>Check Uniforms Purchased</h2>
				<ul class="buttons">
