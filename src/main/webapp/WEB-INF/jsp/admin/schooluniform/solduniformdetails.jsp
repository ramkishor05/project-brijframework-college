...
<script>
	...
	function getSoldUniformDetails() {
					...
					.ajax({
						...
						if(length==0)
							...
							+'<table cellpadding="0" cellspacing="0" width="100%" class="table"><thead><tr><th>Date</th><th>Student Name</th><th>Father Name</th><th>Class</th>'
									+ '<th>Section</th><th>Payment Mode</th><th>Total Amount</th><th>Discount</th><th>Paid Amount</th><th>Dues</th><th>Mobile no.</th><th>Uniform details</th><th>View Receipt</th></tr></thead><tbody>';
							for ( var i = 0; i < length; i++) {
								if (j[i].paidStatus == 'InHand') {
									...
									content += '<td style="background-color: lightgray;"><a href="javascript:viewmore('
											...
											+ '</td><td style="background-color: lightgray;"><a href="getUniformReceipt?id='
											+ j[i].receiptno
								...
								if (j[i].paidStatus == 'Cancel') {
									...
									content += '<td style="background-color: pink;">'
											...
											+ j[i].receiptno
											+ ');"><span class="label label-primary">Show</span></a>'
											+ '</td><td style="background-color: pink;"><a href="getUniformReceipt?id='
											+ j[i].receiptno
											+ '" target="_blank"><span class="label label-success">Receipt</span></a></td></tr>';
								...
								if (j[i].paidStatus == 'Completed') {
									...
									content += '<td style="color:green;">'
											...
											+ j[i].receiptno
											+ ');"><span class="label label-primary">Show</span></a>'
											+ '</td><td><a href="getUniformReceipt?id='
											+ j[i].receiptno
											+ '" target="_blank"><span class="label label-success">Receipt</span></a></td></tr>';
...
<div class="content">
	<div id="content-header" style="height: 150px;">
		...
		<h1>Sold Uniform Details</h1>
		<h3>View Datewise Sold Uniform Details</h3>
	...
	<div class="row-form">
		...
		<div class="span4">
			<input type="text" class="datepicker validate[required]"
				...
				onchange="getSoldUniformDetails();">
		</div>
	</div>
	<div class="row-form">
		<div class="span3"></div>
	...
	<div class="row-fluid">
		<div class="span12">
			<div class="block"  style="left: -14px;">
				<div class="head blue" style="width: 1047px;">
					<div class="icon">
						<span class="ico-pen-2"></span>
					</div>
					<h2>Detail List</h2>
