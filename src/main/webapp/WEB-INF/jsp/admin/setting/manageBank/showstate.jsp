	...
	<div style="padding: 10px 0 0;" class="widget-body">
		<div class="block">
			...
			<table class="table table-bordered table-primary"
				...
				<tbody>
					<c:forEach var="list" items="${statelist}" varStatus="loop">
						<tr>
							<td class="center">${list.stateName}</td>
							<%-- <td>${list.stateCode}</td> --%>
							<td class="center"><a href="editstate?id=${list.stateId}"><font
									size="2">Edit</b></font></a></td>
						</tr>
