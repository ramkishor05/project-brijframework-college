...
<div class="content">
	...
	<f:form id="validate" method="POST" enctype="multipart/form-data"
		action="StudentAdmission" commandName="studentAdmissionDTO">
		<div class="row-fluid">
				...
				<div class="block">
					...
					<div class="data-fluid">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="studentName" 	maxlength="30" class="validate[required,minSize[2],maxSize[30]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
						...
						<div class="row-form">
							...
							<div class="span9">
								<textarea placeholder="Enter Address" maxlength="300"
				...
				<div class="block">
					...
					<div class="data-fluid">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="fatherName" id="firstName"
									maxlength="30" class="validate[required,minSize[2],maxSize[50]]">
							</div>
						</div>
						<div class="row-form">
						...
						<div class="row-form">
							...
							<div class="span7">
								<input type="text" name="fatherPhoneNo" id="mobile"
				...
				<div class="block">
					<div class="head">
						...
						<div class="row-form">
							...
							<div class="span7">
								<input type="text" name="motherPhoneNo" id="mobile"
									maxlength="10" placeholder="Enter 10 Digit Number">
							</div>
						</div>
						<div class="row-form">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="schoolAddress" id="schoolAddress"
									maxlength="100" class="validate[minSize[2],maxSize[100]]">
							</div>
						</div>
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="schoolPhone" id="schoolPhone"
									maxlength="10"
									class="validate[minSize[10],maxSize[11],custom[integer]]">
							</div>
						</div>
						<legend>
							<font color="green">${msg}</font>
				...
				<div class="block">
					...
					<div class="data-fluid">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="brotherOrSisterName1" maxlength="50">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">Age:</div>
							<div class="span9">
								<input type="text" name="brotherOrSisterAge1" maxlength="10">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">Class :</div>
							<div class="span9">
								<input type="text" name="brotherOrSisterClass1" maxlength="10">
							</div>
						</div>
						<div class="row-form">
				...
				<div class="block">
					...
					<div class="data-fluid">
						<div class="row-form">
							<div class="span3">Name:</div>
							<div class="span9">
								<input type="text" name="brotherOrSisterName2" maxlength="50">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">Age:</div>
							<div class="span9">
								<input type="text" name="brotherOrSisterAge2" maxlength="10">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">Class :</div>
							<div class="span9">
								<input type="text" name="brotherOrSisterClass2" maxlength="10">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">School/College:</div>
