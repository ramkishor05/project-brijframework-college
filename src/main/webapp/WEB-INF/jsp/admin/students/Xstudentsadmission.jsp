			...
			<div class="span6">
				...
				<div class="block">
					...
					<div class="data-fluid">
						<div class="row-form">
							<div class="span3">
								Admission No/S R No:<font color="red"></font>
							</div>
							<div class="span9">
								<input type="text" name="admissionNo"
									placeholder="Enter Admission No.(Optional)" 
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="lfno" id="lfno" maxlength="15"
									value="${lfNO}">
							</div>
						</div>
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="firstName" id="firstName"
									maxlength="30"
									class="validate[required,minSize[2],maxSize[30]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
							...
							<div class="span9">
								<input type="text" placeholder="(Optional)" name="middleName"
									maxlength="30" id="secondName"
									class="validate[minSize[1],maxSize[30]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
							...
							<div class="span9">
								<input type="text" name="lastName" id="lastName" maxlength="30"
									...
									class="validate[minSize[3],maxSize[30]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="motherName" id="lastName"
									maxlength="30"
									class="validate[required,minSize[4],maxSize[30]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
							...
							<div class="span9">
								<input type="text" name="guardianName" id="guardianName"
									maxlength="30"
									class="validate[minSize[4],maxSize[30]]">
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
				...
				<div class="block">
					...
					<div class="data-fluid">
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="studentId" id="studentId" maxlength="5" readonly="readonly"
									value="${studentId}" style="width: 319px; margin-left: 41px;">
							</div>
						</div>
						<div id="wizard_validate-titles" class="stepy-titles"></div>
				...
				<div class="block">
					<div class="head">
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" placeholder="(Optional)" maxlength="6"
									name="pinCode" id="pinCode"
									class="validate[custom[integer],minSize[6]]">
							</div>
						</div>
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="phone" id="Phone"
									placeholder="(Optional)" maxlength="11"
									class="validate[custom[integer],minSize[6],maxSize[11]]">
							</div>
						</div>
						...
						<div class="row-form">
							...
							<div class="span9">
								<input type="text" name="schoolName" id="schoolName"
									maxlength="50"
									class="validate[minSize[2],maxSize[50]]">
							</div>
						</div>
						<div class="row-form">
