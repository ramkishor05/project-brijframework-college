				...
				<div class="block">
					...
					<div class="data-fluid">
						...
						<div class="row-form">
							...
							<div class="span9">
								<f:input type="text" path="middleName" placeholder="(Optional)"
									id="secondName" />
							</div>
						</div>
						<div class="row-form">
					...
					<div class="data-fluid">
						<div class="row-form" style="width: 494px;">
							...
							<div class="span9" style="margin-left: -11px;">
								<f:input id="admissionDate" class="validate[required]"
									type="text" readonly="readonly" path="admissionDate"
						...
						<div class="row-form">
							...
							<div class="span9">
								<f:input placeholder="(Optional)" path="srno" id="srno" />
							</div>
						</div>
						<div class="row-form">
							<div class="span3">
				...
				<div class="block">
					<div class="head">
						...
						<div class="row-form">
							...
							<div class="span9">
								<f:input type="text" path="pinCode" id="pinCode"
									placeholder="(Optional)" />
							</div>
						</div>
						...
						<div class="row-form">
							...
							<div class="span9">
								<f:input type="text" path="mobile" id="mobile"/>
							</div>
						</div>
