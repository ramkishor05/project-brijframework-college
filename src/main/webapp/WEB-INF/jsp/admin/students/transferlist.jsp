...
<script>
	function getCancelledList(sessionId) {
		var url = 'regTransferList/' + sessionId;
		$
				.ajax({
					url : url,
					type : 'POST',
					success : function(data, status) {
						...
						if (length == 0) {
							...
							st = '<div><div class="widget-body" style="padding: 10px 0 0;"><div class="separator"></div><div class="btn-group" style="width: 1059px;">'
									...
									+ '<table class="table table-bordered table-primary"><thead><tr><th>Reg.No.</th><th>Student Name</th><th>Father Name</th><th>Mother Name</th><th>Class</th><th>DOB</th><th>Phone No</th><th>View Form</th></tr></thead><tbody>';
							...
							for ( var i = 0; i < length; i++) {
								st = st
										...
										+ j[i].phoneNo + '</td><td><a href="show-application?id='+ j[i].studentId+'" target="_blank">View</a></td></tr>';
