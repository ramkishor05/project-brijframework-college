...
<div class="content">
	<div id="content-header" style="height: 150px;">
		<img alt="Show_settings"
			src="${img_url}/employeeImages/reportcardmain.png"
			style="width: 57px;">
	...
	<div id="user_options">
		...
		<div class="button-box left-button" style="width: 190px;">
			<a href="final-exam-menu-page.html" class="option_buttons"
				id="admission_button"
				nicetitle="Enter students admission details into the school records."><div
					...
					<p style="margin-left: 15px; margin-top: 10px;">Annually Exam
						</p>
				</div></a>
		</div>
		<div class="button-box">
			<a href="monthly-exam-menu.html" class="option_buttons"
				id="student_details_button"
				nicetitle="Search for existing and former students."><div
					class="button-label">
					<img alt="" src="${img_url}/employeeImages/monthlyexamsection.png"
						style="margin-left: -20px; margin-top: -100px; height: 100px;">
					<p style="border-top-width: 0px; margin-top: 10px;">Monthly
						Exam</p>
				</div></a>
		</div>
	</div>
