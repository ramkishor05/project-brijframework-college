...
<div class="content">
	<div id="content-header" style="height: 150px;">
		<img alt="Show_settings" src="${img_url}/employeeImages/reportcard.png"
			style="width: 57px;">
		<h1>Final Exam Report Home</h1>
		<h3>Final Exam Report Home</h3>
	...
	<div id="user_options">
		...
		<div class="button-box left-button" style="width: 200px;">
			<a href="assign-annual-marks-to-student.html" class="option_buttons"
				id="admission_button"
				nicetitle="Enter students admission details into the school records."><div
					class="button-label">
					<img alt="" src="${img_url}/employeeImages/createreportcard.png"
						style="margin-left: 40px; margin-top: -100px; height: 100px;">
					<p style="margin-left: 30px; margin-top: 10px;">Create Report Card </p>
				</div></a>
		</div>
		<div class="button-box">
			<a href="view-student-report-cards.html" class="option_buttons"
